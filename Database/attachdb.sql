...
insert into #backupInformation exec('restore filelistonly from disk = ''$(root)\$(backupfile)''')
...
FROM DISK = '$(root)\$(backupfile)'
WITH REPLACE,
MOVE @logicalNameD TO 'C:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\DATA\$(database).mdf',
MOVE @logicalNameL TO 'C:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\DATA\$(database).ldf'